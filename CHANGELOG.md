...
- [**Breaking change**] Given alg header value is not overridden by used algorithm anymore [#557](https://github.com/jwt/ruby-jwt/issues/557) ([@anakinj](https://github.com/anakinj))
